...
<p>
  This is a desktop wallet for Sequin that uses <a href="http://electron.atom.io/">Electron</a>, <a href="https://facebook.github.io/react/">React</a>, <a href="https://github.com/sequin/sequin-wallet-backend-js">Sequin-Wallet-Backend-JS</a>, <a href="https://github.com/reactjs/redux">Redux</a>, <a href="https://github.com/reactjs/react-router">React Router</a>, <a href="http://webpack.github.io/docs/">Webpack</a> and <a href="https://github.com/gaearon/react-hot-loader">React Hot Loader</a>.
</p>
...
```bash
git clone https://github.com/sequin/sequin-desktop-wallet.git
```

And then install the dependencies with yarn.

```bash
$ cd sequin-desktop-wallet
$ yarn
```
