        ...
        const modalMessage = (
          <div>
            ...
            <p className={`subtitle ${textColor}`}>
              ...
              <br />
              {atomicToHuman(amount + nodeFee + fee, true)} SQN
            </p>
            <p className={`subtitle ${textColor}`}>
              <b>Fee:</b>
              <br />
              {atomicToHuman(nodeFee + fee, true)} SQN
              {nodeFee > 0 &&
    ...
    const transactionData = {
      ...
      amount:
        displayCurrency === 'SQN'
          ...
          : parseInt((Number(enteredAmount) * 1000000) / fiatPrice),
      paymentID,
      sendAll
    };
    ...
    const addressInput = (
      ...
      >
        <Creatable
          ...
          placeholder="Enter a SQN address or a contact name to send funds to"
