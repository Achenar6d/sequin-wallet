...
export const directories = [
  `${homedir}/.sequinwallet`,
  `${homedir}/.sequinwallet/logs`
];
...
log.debug(`Sequin wallet started...`);
...
function handleAbout() {
  remote.shell.openExternal(
    'https://github.com/Achenar6d/sequin-wallet#readme'
  );
}

function handleHelp() {
  remote.shell.openExternal('https://sequin.network');
}

function handleIssues() {
  remote.shell.openExternal(
    'https://github.com/Achenar6d/sequin-wallet/issues'
  );
}
